...
import { TemplateModel, TemplateReview, TemplateManifest } from '../models/template.model';
...
export interface ITemplateRepository {
  ...
  findByAuthor(authorId: string, options?: QueryOptions): Promise<TemplateModel[]>;
  findByCategory(category: string, options?: QueryOptions): Promise<TemplateModel[]>;
...
export interface IAuthorRepository {
  ...
  update(id: string, author: Partial<MarketplaceAuthor>): Promise<MarketplaceAuthor>;
  delete(id: string): Promise<void>;
...
export interface IReviewRepository {
  ...
  findByTemplate(templateId: string, options?: QueryOptions): Promise<TemplateReview[]>;
  findByAuthor(authorId: string, options?: QueryOptions): Promise<TemplateReview[]>;
...
export interface IInstallationRepository {
  ...
  getInstallHistory(templateId: string, days?: number): Promise<Array<{date: Date; count: number}>>;
}
