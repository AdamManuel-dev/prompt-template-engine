...
describe('LoginPage', () => {
  ...
  describe('Rendering', () => {
    it('should render login form with initial state', () => {
      ...
      expect(screen.getByText('Sign in to access the non-developer template portal')).toBeInTheDocument()
      expect(screen.getByRole('tab', { name: 'Username/Email' })).toBeInTheDocument()
  ...
  describe('API Key Visibility', () => {
    it('should toggle API key visibility', async () => {
      ...
      const apiKeyField = screen.getByLabelText('API Key')
      const toggleButton = screen.getByTestId('VisibilityIcon').closest('button') as HTMLButtonElement
